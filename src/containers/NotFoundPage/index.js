...
// Data
import {entertainments} from "../../common/data/notFoundPage"
                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className="back4040 text-center col-lg-6 m-auto">
                                ...
                                <p>Lo sentimos, la página que buscaba no se encuentra. Intente buscar la mejor coincidencia 
                                    o navegue por los siguientes enlaces:</p>
                                <div className="space-20"/>
                                <div className="button_group"><Link to="/" className="cbtn2">IR A INICIO</Link>
                                    <Link to="/contact" className="cbtn3">Contáctanos</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="row">
                                <div className="col-6 align-self-center">
                                    <div className="heading">
                                        <h2 className="widget-title">Archivo</h2>
                                    </div>
                                </div>
